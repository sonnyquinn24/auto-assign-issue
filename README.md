...
| `failsIfUsersCannotBeAssigned` | Boolean | false                                | false   | Flag that causes the action to fail if one or more users cannot be assigned to an issue. If not set the invalid users are simply ignored.                                                                                                                                                                                                              |
